...
def load_data_from_folder(
    ...
    Args:
        ...
        train_samples (int): number of samples to train the model. To use the whole dataset set it to zero
        val_samples (int): number of samples to val the model. To use the whole dataset set it to zero
        test_samples (int): number of samples to test the model. To use the whole dataset set it to zero
    ...
    if train_samples:
        train_df = train_df.sample(n=train_samples)
    if val_samples:
        val_df = val_df.sample(n=val_samples)
    if test_samples:
        test_df = test_df.sample(n=test_samples)
